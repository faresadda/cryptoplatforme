...
const sidebarItems = [
  ...
  { name: "Convert", icon: <RiExchangeLine />, href: "/user/convert" },
  { name: "Markets", icon: <FaChartLine />, href: "/user/markets" },
  { name: "Mining", icon: <GiMining />, href: "/user/mining" },
  { name: "Assets", icon: <FaCoins />, href: "/user/assets" },
];

export default function Sidebar() {
    
  return (
    <div className="fixed left-0 h-full w-60 bg-[#0f0f0f] text-white shadow-lg p-10 space-y-6 z-10 pt-30 
