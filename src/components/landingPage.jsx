      ...
      <header className="relative overflow-hidden">
        <nav className="absolute top-0 w-full z-50 px-6 py-4">
          <div className="max-w-7xl mx-auto flex justify-between items-center">
            <div className="text-2xl font-bold text-yellow-400">CryptoTrade</div>
            <div className="hidden md:flex space-x-8">
              <a href="#" className="hover:text-yellow-400 transition-colors">Features</a>
              <a href="#" className="hover:text-yellow-400 transition-colors">Markets</a>
            ...
            <div className="flex space-x-4">
              <button className="px-4 py-2 rounded-lg text-yellow-400 hover:text-yellow-300 transition-colors" onClick={() => navigate('/login')}>
                Login
              </button>
              <button className="px-4 py-2 bg-yellow-400 text-black rounded-lg hover:bg-yellow-300 transition-colors" onClick={() => navigate('/signup')}>
                Sign Up
              </button>
            </div>
          </div>
            ...
            <div className="flex justify-between items-center gap-10 max-[945px]:flex-wrap max-[945px]:justify-center">
              <div className="space-y-8">
                ...
                <p className="text-gray-400 text-lg sm:text-xl max-w-lg">
                  ...
                  competitive fees, and institutional-grade security.
                </p>
      ...
      <section className="py-20 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl sm:text-4xl font-bold text-center mb-16">
            Why Choose <span className="text-yellow-400">CryptoTrade</span>
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="p-6 bg-gray-900 rounded-xl border border-gray-800 hover:border-yellow-400 transition-colors flex flex-col items-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-yellow-400">Exchange</a></li>
                <li><a href="#" className="hover:text-yellow-400">Wallet</a></li>
                <li><a href="#" className="hover:text-yellow-400">Card</a></li>
                <li><a href="#" className="hover:text-yellow-400">NFT</a></li>
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-4">Services</h3>
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-yellow-400">Trading</a></li>
                <li><a href="#" className="hover:text-yellow-400">Staking</a></li>
                <li><a href="#" className="hover:text-yellow-400">Lending</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#" className="hover:text-yellow-400">Guides</a></li>
